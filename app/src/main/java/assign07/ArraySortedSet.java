...
public class ArraySortedSet<E extends Comparable<? super E>> implements SortedSet<E> {
    ...
    private void doubleArraySize() {
        // Creates a copy of the original array and resets the old array with a doubled
        // size
     ...
     * @return Returns the index if the element was found (or an index of where it
     *         should be)
     * @note Method was copied from SortedArrayList in assignment 3
     */
    ...
    private void insert(E element) {
        ...
        // The ternary operator changes the searchResult value to the right index if the
        // element is new to the array
